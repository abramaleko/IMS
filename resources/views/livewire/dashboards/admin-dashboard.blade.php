    ...
    <div class="mt-4">
      <div class="">
       <p class="text-lg">
        Filter :
            @if ($projectFilter)
              <span class="badge badge-primary badge-lg">By Project</span>
            @endif
            @if ($searchInput)
              <span class="badge badge-primary badge-lg">By Search</span>
            @endif
            @if ($dateFilter)
            <span class="badge badge-primary badge-lg">By Date</span>
          @endif
