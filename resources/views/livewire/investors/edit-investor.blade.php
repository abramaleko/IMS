                            ...
                            <div class="mb-4 col-xl-6 col-md-6">
                              ...
                              <div class="mb-4 col-xl-6 col-md-6">
                                ...
                                <div class="mb-3 input-group">
                                    <div class="form-file">
                                        <input type="file" class="form-file-input form-control" disabled>
                                    </div>
                                </div>
                                  <span class="text-muted">This field can not be edited</span>
                              </div>
              ...
              <div class="col-xl-12">
                  <div class="card">
                      ...
                      <div class="card-footer text-end">
                          <div>
                              <a href="javascript:void(0);" wire:click="resetForm" class="btn btn-primary me-3">Reset</a>
                              <a href="javascript:void(0);" wire:loading.remove wire:click='submitFinal' class="btn btn-success">Update Investor</a>
